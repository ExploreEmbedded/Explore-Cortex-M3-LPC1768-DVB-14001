...
/***************************************************************************************************
                  void GPIO_PinDirection(gpioPins_et enm_pinNumber, gpioDirection_et enm_pinDirn)
 ***************************************************************************************************
 * I/P Arguments: 
...
void GPIO_PinWrite(gpioPins_et enm_pinNumber, uint8_t var_pinValue_u8)
{
    ...
    if(var_pinValue_u8!=0)
    {
        util_BitSet(LPC_GPIO_PORT->FIOSET,var_pinNumber_u8);        
    }
    else
    {
        util_BitSet(LPC_GPIO_PORT->FIOCLR,var_pinNumber_u8); 
    }
